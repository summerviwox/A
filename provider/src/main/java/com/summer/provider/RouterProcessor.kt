...
//                            .build();
//
//                        var javaFile = JavaFile.builder("com.summer.router", testRouterInit)
//                        .build();
...
//            file = filer?.createResource(StandardLocation.SOURCE_OUTPUT,"","com.summer.router.RouterProvider.kt")
//            var path = file?.toUri()?.path
//            var writer = file?.openWriter()
//            //println("RouterProvider")
//            writer?.apply {
//                writer.write("package com.summer.router\n")
...
////        try {
////            //createSourceFile 会创建ProviderManager.kt.java 用createResource
////            file = filer?.createResource(StandardLocation.SOURCE_OUTPUT,"","com.summer.router.RouterPath.kt")
////            var path = file?.toUri()?.path
////            var writer = file?.openWriter()
